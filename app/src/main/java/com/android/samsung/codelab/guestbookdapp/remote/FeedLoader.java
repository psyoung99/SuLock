...
//    }
    ...
    private Feed getPost(int index) throws Exception {
        ...
        String context = types.get(2).getValue().toString();
        Log.d("test",context);

//        View view = View.inflate(this.con,R.layout.item_feed_list,null);
//        TextView tv = view.findViewById(R.id.txt_user_comment3);
        if(Double.parseDouble(context)>8.0) {
            Log.d("test",types.indexOf(types.get(2).getValue())+"정상");
        } else {
...
//        String context = types.get(2).getValue().toString();
//        Log.d("test",context);
//        double contextDouble = Double.parseDouble(context);
//            if (contextDouble > 8.0) {
//                Log.d("texttest true", "tr: " +contextDouble );
//                text.setTextColor(Color.RED);
//            } else {
//                Log.d("texttest false", "fa: " + text.toString());
//            }
